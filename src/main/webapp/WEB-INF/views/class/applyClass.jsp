...
<div class="signUp-container">
	<form method="post" action="<%=request.getContextPath()%>/applyClass">
				...
				<div class="applyClass-detail">
					<div class="applyClass-monthly">
						<span>할부개월: </span>
							...
							<c:if test="${classList.class_monthlyPay == 1}">
								<span>일시불</span>
								<input type="text" name="class_monthlyPay" value="1" readonly style="visibility: hidden;">
							</c:if>
							<c:if test="${classList.class_monthlyPay == 3}">
								<span>3개월</span>
								<input type="text" name="class_monthlyPay" value="3" readonly style="visibility: hidden;">
							</c:if>
							<c:if test="${classList.class_monthlyPay == 5}">
								<span>5개월</span>
								<input type="text" name="class_monthlyPay" value="5" readonly style="visibility: hidden;">								
							</c:if>
							<c:if test="${classList.class_monthlyPay == 6}">
								<span>6개월</span>
								<input type="text" name="class_monthlyPay" value="6" readonly style="visibility: hidden;">								
							</c:if>
							<c:if test="${classList.class_monthlyPay == 12}">
								<span>12개월</span>
		...
		<c:if test="${paymentInfo ne null}">
			...
			<div class="box-title">CVC</div>
			<div class="signup-box">
		  		<input type="text" id="payment_cardCVC" name="payment_cardCVC" class="user-name" maxlength="3" value="${paymentInfo.payment_cardCVC}">
		   	</div>	
			<div class="vipPlan-infos card-extraInfo">
				<div>
					<div class="box-title">비밀번호</div>
		...
		<button class="submitButton" disabled>클래스 신청</button>
	</form>	
</div>
