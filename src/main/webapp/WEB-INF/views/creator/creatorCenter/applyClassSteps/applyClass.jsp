...
<div class="applyClass-rightContainer">
	<div class="applyClass-classInfos">
		<div id="pageView">
			<form method="post" action="<%=request.getContextPath()%>/creator/applyClass">
				...
				<div class="applyClass-introduction display-toggle">
					...
					<div class="class-setPackage">
						...
						<div class="class-isPackage">
							<input type="radio" name="setPackage" value="y"> 패키지 있음
							<input type="radio" name="setPackage" value="n"> 패키지 없음
						</div>
						<div class="setPackageContent">
							<span>클래스에 필요한 패키지 구성을 상세하게 작성해주세요.</span>
							<textarea id="packageList" name="editordata"></textarea>
						</div>
					</div>
					...
					<div class="class-curriculum">
						...
						<div class="">본격적인 콘텐츠는 개설 승인 이후 업로드가 가능합니다. 때문에 신청 전에 수업 구성 및 순서를 먼저 정해주시고 신청해주세요. <br>
				...
				<div class="applyClass-creatorInfo display-toggle">
					<div>
 					...
 					<textarea id="creatorIntroduction" name="editordata"></textarea>		
				</div>
				...
				<div class="applyClass-classCheck display-toggle">
					<div class="">
						...
						<div class="applyClass-notification-container">
							<div class="applyClass-notification">
								<span>신청하기 전에 다음 주의 사항을 반드시 숙지해주세요.</span>
								...
								2. 본격적인 콘텐츠 추가는 클래스 개설 승인이 난 이후 추가가 가능합니다. 단, 승인된 날짜를 기준으로 14일이 지나도 최종본이 올라오지 않을 시 개설 취소 됨을 알려드립니다. <br>
								만약 콘텐츠 수정 사유로 14일을 넘기게 될 경우엔 1회 한정으로 7일 기한을 더 드릴 예정이니 필요한 경우 운영진에게 문의해 주십시오. <br><br>
					...
					<div>
						<span>해당 주의 사항을 모두 읽으셨으면 개설 신청버튼을 눌러주세요. 버튼을 누르면 해당 사항을 숙지한 것으로 간주됩니다.</span>
						<button>개설 신청</button>
					</div>
				</div>
